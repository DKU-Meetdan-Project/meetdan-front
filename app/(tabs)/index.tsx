        ...
        <FlatList
          ...
          ListEmptyComponent={
             <View style={{ alignItems: 'center', marginTop: 50 }}>
               <Text style={{ color: '#999', marginBottom: 10 }}>등록된 과팅이 없습니다.</Text>
               <Text style={{ color: '#999' }}>아래 '방 만들기' 탭에서 직접 만들어보세요!</Text>
             </View>
          }
        />
      </View>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 12, padding: 20, marginBottom: 12, borderWidth: 1, borderColor: '#f0f0f0' },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  deptBadge: { backgroundColor: '#f5f5f5', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4 },
  deptText: { fontSize: 12, color: '#666', fontWeight: '600' },
  timeText: { fontSize: 12, color: '#aaa' },
  title: { fontSize: 17, fontWeight: 'bold', color: '#222', marginBottom: 12, lineHeight: 24 },
  infoRow: { flexDirection: 'row', marginBottom: 12 },
  infoBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 20 },
